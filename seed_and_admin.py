...
products = [
    ("狂犬疫苗(单针)",cat1,80,"/static/images/products/vaccine-rabies.png","宠物医院专用狂犬疫苗，安全有效",99),
    ("犬四联疫苗(卫佳伍)",cat1,120,"/static/images/products/vaccine-dhpp.png","预防犬瘟热、细小病毒等四种传染病",50),
    ("猫三联疫苗(妙三多)",cat1,150,"/static/images/products/vaccine-feline.png","预防猫瘟、猫鼻支、猫杯状病毒",50),
    ("皇家狗粮15kg",cat2,320,"/static/images/products/food-dog.png","成犬用，营养均衡，适口性好",30),
    ("渴望猫粮5kg",cat2,280,"/static/images/products/food-cat.png","六种鱼配方，富含Omega-3",25),
    ("宠物零食鸡肉干",cat2,35,"/static/images/products/treat-chicken.png","天然风干鸡胸肉，无添加",100),
    ("发声玩具球",cat3,25,"/static/images/products/toy-ball.png","狗狗猫咪都爱玩的发声球",200),
    ("逗猫棒(羽毛款)",cat3,18,"/static/images/products/toy-cat-wand.png","猫咪最爱的互动玩具",150),
    ("漏食球益智玩具",cat3,45,"/static/images/products/toy-puzzle.png","藏食设计，让宠物边玩边吃",80),
    ("项圈牵引绳套装",cat4,55,"/static/images/products/leash-collar.png","舒适透气，防挣脱设计",60),
    ("宠物猫狗通用睡垫",cat4,89,"/static/images/products/pet-bed.png","加厚柔软，四季通用",40),
    ("宠物外出水壶",cat4,38,"/static/images/products/water-bottle.png","一键出水，便携设计",70),
    ("宠物指甲剪套装",cat4,29,"/static/images/products/nail-clipper.png","防误剪设计，含磨甲刀",90),
    ("益生菌(调理肠胃)",cat5,68,"/static/images/products/probiotics.png","改善宠物肠胃健康，调理软便",45),
    ("鱼油软胶囊(护毛)",cat5,88,"/static/images/products/fish-oil.png","富含Omega-3，美毛护肤",35),
]
